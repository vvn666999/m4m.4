        <header>
            ...
            <nav class="navbar navbar-expand-lg header-transparent bg-transparent disable-fixed border-bottom border-color-transparent-white-light">
                <div class="container-fluid"> 
                    <div class="col-auto">
                        <a class="navbar-brand" href="index.php" data-link>
                    ...
                    <div class="col-auto menu-order left-nav ps-60px lg-ps-20px md-ps-15px">
                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                            <ul class="navbar-nav"> 
                                <li class="nav-item"><a href="index.php" data-link class="nav-link">Home</a></li>
                                ...
                                <li class="nav-item"><a href="index.php?route=login" class="nav-link" data-link>Login</a></li>
                                <li class="nav-item"><a href="index.php?route=register" class="nav-link" data-link>Register</a></li>
                            </ul>
                        </div>
                    </div>
